...
const experiences = [
  {
    ...
    description: "Leading the development of complex enterprise applications and government portals.",
    achievements: [
      "Government projects and portals",
      "E-commerce applications",
      "HRM systems development",
      "Multi-vendor systems architecture",
      "Premium brochure websites"
    ]
  },
  {
    ...
    description: "Specialized in backend architecture and complex business logic implementation.",
    achievements: [
      "POS & Inventory systems",
      "Share market platforms",
