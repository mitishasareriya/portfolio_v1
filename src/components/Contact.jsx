        ...
        <div className="grid lg:grid-cols-2 gap-12 max-w-6xl mx-auto items-start">
          ...
          >
            ...
            <p className="text-textSecondary mb-10 leading-relaxed text-lg max-w-md">
              I'm currently available for new projects and opportunities. Whether you have a question or just want to say hi, I'll try my best to get back to you!
            </p>
            ...
            <div className="space-y-6">
              <div className="flex items-center gap-5 group cursor-pointer">
                ...
                <div>
                  ...
                  <p className="text-lg font-medium text-textPrimary group-hover:text-primary transition-colors">+91 9428298088</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-5 group cursor-pointer">
                ...
                <div>
                  ...
                  <p className="text-lg font-medium text-textPrimary group-hover:text-secondary transition-colors">mitisha.sareriya@gmail.com</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-5 group cursor-pointer">
                ...
                <div>
                  ...
                  <p className="text-lg font-medium text-textPrimary group-hover:text-accent transition-colors">Mitisha Sareriya</p>
                </div>
              </div>
            </div>
          </motion.div>
