...
const educationData = [
  {
    ...
    institution: "Saurashtra University (Department Of Computer Science)",
    period: "Sept 2023 – May 2025",
  },
  {
    degree: "BCA - Bachelor of Computer Applications",
    institution: "SMT. K.S.N. Kansagara College",
    period: "July 2020 – April 2023",
  },
  {
    degree: "HSC - Higher Secondary Certificate",
    institution: "Shree G K Dholakiya English Medium School",
    period: "March 2020",
  },
  {
    degree: "SSC - Secondary School Certificate",
    institution: "Shree V J Modi English Medium School",
    period: "March 2018",
  }
];
  ...
  return (
    <section id="education" className="py-24 relative z-10 overflow-hidden bg-background">
      ...
      <div className="container mx-auto px-6 md:px-12 relative">
        ...
        >
          <h2 className="text-3xl md:text-5xl font-bold font-display mb-4 text-textPrimary">Education <span className="text-gradient">Journey</span></h2>
